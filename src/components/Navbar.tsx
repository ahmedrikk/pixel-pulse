      ...
      <nav className="sticky top-0 z-50 w-full border-b border-nav-border bg-nav backdrop-blur-sm">
        <div className="container flex h-14 items-center gap-3">
          ...
          <button
            ...
            className="md:hidden flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-black text-foreground"
          ...
          <div className="md:hidden flex-1 flex justify-center">
            <a href="/" className="flex items-center gap-1.5 font-bold text-base">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {/* Mobile: sparkle/star icon placeholder */}
