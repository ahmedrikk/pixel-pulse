    ...
    <div className="bg-background px-6 py-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
        ...
        <div className="bg-background border border-border/60 rounded-xl p-3.5 relative overflow-hidden group hover:border-primary/40 transition-colors">
          <span className="absolute top-3 right-3 text-tiny-label font-medium text-muted-foreground/50 group-hover:text-primary transition-colors">
            01
          </span>
          ...
          <h3 className="text-tiny-label font-medium text-foreground mb-1">Read gaming news</h3>
          <p className="text-tiny-label text-muted-foreground leading-relaxed">
            Every article summary you read awards XP. The more you read, the faster you climb.
          </p>
          <div className="inline-block mt-2 bg-primary/10 text-primary text-tiny-label font-medium px-2 py-0.5 rounded-lg border border-primary/15">
        ...
        <div className="bg-background border border-border/60 rounded-xl p-3.5 relative overflow-hidden group hover:border-primary/40 transition-colors">
          ...
          <h3 className="text-tiny-label font-medium text-foreground mb-1">Predict esports matches</h3>
          <p className="text-tiny-label text-muted-foreground leading-relaxed">
            Call winners before matches kick off. Get it right, earn bonus XP on top of your prediction XP.
          </p>
          <div className="inline-block mt-2 bg-amber-500/10 text-amber-600 dark:text-amber-400 text-tiny-label font-medium px-2 py-0.5 rounded-lg border border-amber-500/20">
        ...
        <div className="bg-background border border-border/60 rounded-xl p-3.5 relative overflow-hidden group hover:border-primary/40 transition-colors">
          ...
          <h3 className="text-tiny-label font-medium text-foreground mb-1">Review games</h3>
          <p className="text-tiny-label text-muted-foreground leading-relaxed">
            Rate and review games you've played. Your opinions help the community — and earn you XP.
          </p>
          <div className="inline-block mt-2 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-tiny-label font-medium px-2 py-0.5 rounded-lg border border-emerald-500/20">
        ...
        <div className="bg-background border border-border/60 rounded-xl p-3.5 relative overflow-hidden group hover:border-primary/40 transition-colors">
          ...
          <h3 className="text-tiny-label font-medium text-foreground mb-1">Daily trivia quizzes</h3>
          <p className="text-tiny-label text-muted-foreground leading-relaxed">
