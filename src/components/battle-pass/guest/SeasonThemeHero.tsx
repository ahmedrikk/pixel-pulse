    ...
    <div className={styles.themeHero}>
      ...
      <div className="relative z-10 flex justify-between items-center px-6 py-3.5 border-b" style={{ borderBottomColor: 'rgba(255,255,255,0.06)' }}>
        <div className="flex items-center gap-4">
          <span className="text-tiny-label font-medium px-2.5 py-1 rounded-[10px]" style={{ background: '#3d59e0', color: '#eef1ff' }}>
          ...
          <div className="flex gap-1.5">
            {season.acts.map((act: any) => {
              ...
              return (
                <span 
                  key={act.number}
                  className="text-tiny-label px-2 py-0.5 rounded-lg border"
                  style={isActive ? {
        ...
        <div className="text-tiny-label text-white/40">
      ...
      <div className="relative z-10 px-6 pt-7">
        <div className="text-tiny-label font-medium tracking-[0.12em] uppercase text-white/35 mb-2">
        ...
        <div className="text-count-meta text-white/55 leading-relaxed max-w-[480px] mb-6 pl-3.5" style={{ borderLeft: '2px solid var(--season-primary)' }}>
          {season.lore}
        </div>
      </div>
      ...
      <div className="relative z-10 flex border-y" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
        <div className="flex-1 p-3.5 px-5 border-r" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="text-tiny-label text-white/35 tracking-wider mt-0.5">Free tiers</div>
          <div className="text-tiny-label text-white/25">No purchase needed</div>
        </div>
        <div className="flex-1 p-3.5 px-5 border-r" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <div className="text-xl font-medium text-white">{season.acts?.length || 5}</div>
          <div className="text-tiny-label text-white/35 tracking-wider mt-0.5">Acts</div>
          <div className="text-tiny-label text-white/25">New quests each act</div>
        </div>
        <div className="flex-1 p-3.5 px-5 border-r" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <div className="text-xl font-medium text-white">{daysRemaining}d</div>
          <div className="text-tiny-label text-white/35 tracking-wider mt-0.5">Remaining</div>
          <div className="text-tiny-label text-white/25">Season ends {formattedEndDate}</div>
        </div>
        <div className="flex-1 p-3.5 px-5 border-r" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <div className="text-xl font-medium text-white">+{season.signupXpBonus} XP</div>
          <div className="text-tiny-label text-white/35 tracking-wider mt-0.5">Signup bonus</div>
          <div className="text-tiny-label text-white/25">Instant on join</div>
        </div>
        <div className="flex-1 p-3.5 px-5">
          <div className="text-xl font-medium text-white">{formatMemberCount(season.memberCount)}</div>
          <div className="text-tiny-label text-white/35 tracking-wider mt-0.5">Members earning</div>
          <div className="text-tiny-label text-white/25">This season</div>
        </div>
      </div>
    </div>
  );
